...
print("______________Extensions in riscv extensions landscape_________________")
print("\n")
for i in extensions:
    print(i)
print("\n")
...
print("##################")
print("List of instructions with multiple extensions")
print("##################")
print("\n")
print(mul_ext)
print("\n")
...
print("##################")
print(
    "---- Set of instructions with multiple extensions illustrated with their instructions. -------"
)
print("##################")
print("\n")
